...
export const Hero = ({ textRef }: HeroProps) => {
  return (
    <div 
      ref={textRef}
    ...
    >
      <div className="text-center flex flex-col items-center">
        <h1 className="text-6xl md:text-8xl lg:text-9xl mb-6 font-serif text-[#1A1A1A] font-light tracking-[0.1em] uppercase leading-none">
          Ship 2 Prod
        </h1>
        <div className="w-24 h-[1px] bg-gradient-to-r from-transparent via-[#1A1A1A] to-transparent mb-10 opacity-20" />
        <p className="text-sm md:text-base text-[#444444] font-sans max-w-xl leading-relaxed tracking-[0.4em] uppercase font-light">
